...
val compileDefaultRuntimeClasspath = configurations.create("compileDefaultRuntimeClasspath") {
    isCanBeConsumed = false
    extendsFrom(configurations.runtimeClasspath.get())
}
val compileCustomRuntimeClasspath = configurations.create("compileCustomRuntimeClasspath") {
    isCanBeConsumed = false
    extendsFrom(configurations.runtimeClasspath.get())
}
val runtimeDefaultRuntimeClasspath = configurations.create("runtimeDefaultRuntimeClasspath") {
    isCanBeConsumed = false
    extendsFrom(configurations.runtimeClasspath.get())
}
val runtimeCustomRuntimeClasspath = configurations.create("runtimeCustomRuntimeClasspath") {
    isCanBeConsumed = false
    extendsFrom(configurations.runtimeClasspath.get())
}
...
tasks.register<JavaExec>("runCompileDefault") {
    ...
    description = "Runs the app with the COMPILE_TIME/default-provider bundle on the runtime classpath only."
...
tasks.register<JavaExec>("runCompileCustom") {
    group = "example matrix"
    description = "Runs the app with the COMPILE_TIME/custom-provider bundle on the runtime classpath only."
    mainClass = application.mainClass
...
tasks.register<JavaExec>("runRuntimeDefault") {
    group = "example matrix"
    description = "Runs the app with the RUNTIME/default-provider bundle on the runtime classpath only."
    mainClass = application.mainClass
...
tasks.register<JavaExec>("runRuntimeCustom") {
    group = "example matrix"
    description = "Runs the app with the RUNTIME/custom-provider bundle on the runtime classpath only."
    mainClass = application.mainClass
