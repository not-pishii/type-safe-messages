...
class CompileTimeGenerationTest {
    ...
    void generatesBundleWithPerLocaleFactories() {
        ...
        var contents = assertThat(compilation).generatedSourceFile("com.example.GameMessagesBundle")
        ...
        contents.contains("public static <T> Optional<GameMessages<T>> forLocale(Locale locale, MessageRenderer<T> renderer)");
